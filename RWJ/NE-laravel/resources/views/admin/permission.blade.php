                ...
                <div class="ibox-tools">
                 ...
                 <div class="input-group col-sm-3" style="float: right;position: relative;bottom:8px;">
                    ...
                    <span class="input-group-btn">
                        <a href="{{url('permission/list_add')}}" class="btn btn-primary" style="margin-right: 20px;">添加</a>
                    </span>
                </div>
            </div>
                            ...
                            <div class="example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$v->description}}</td>
                                        <td><a href="{{url('permission/list_edit',$v->id)}}">修改</a> | <a href="{{url('permission/list_del',$v->id)}}" onclick="javascript:return del()">删除</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                </table>
