            ...
            <div class="col-sm-5 col-sm-offset-3">
                <div class="ibox float-e-margins" style="margin:0 auto;">
                    ...
                    <div class="ibox-content">
                        <form role="form" class="form-horizontal m-t" action="{{url('admin/adminlist_insert')}}">
...
<!--                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="status" class="form-control" placeholder="请输入身份">
                                    <!-- <span class="help-block m-b-none">说明文字</span> -->
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">角色：
                                </label>

                                <div class="col-sm-5">
                                    @foreach($role as $roles)
                                    <label class="checkbox-inline">
                                        <input type="checkbox" style="margin-top:2px;" name="role[]"  value="{{$roles->id}}">{{$roles->display_name}}</label>
                                    @endforeach
                                </div>
                            </div>
