            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins" style="margin:0 auto;">
                    ...
                    <div class="ibox-content">
                        <form role="form" class="form-horizontal m-t" action="{{url('banner/insert')}}" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">图片类别：</label>
                                <div class="col-sm-2">
                                    <select class="form-control m-b" name="banner_type" id ="grade" required="">
                                        <option value="0">请选择类别</option>
                                        <option value="列表页" id="g">列表页</option>
                                        <option value="首页" id="g">首页</option>
                                        <option value="品牌商" id="g">品牌商</option>
                                        <option value="类别展示" id="g">类别展示</option>
                                    </select>
                                </div>
                            </div>
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="banner_type" class="form-control" required="">
                                </div>
                            </div> -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div id="file-pretty">
                                        <div class="form-group" style="margin-left:0;margin-right: 0;">
                                            <input type="file" class="form-control" name="photo" style="height:auto;" required="">
                                        </div>
                                    </div>
                                </div>
                                <label class="col-sm-3 control-label" style="text-align: left;">支持jpg、jpeg、png、gif格式，大小不超过2.0M</label>
                            </div>
                            <div class="form-group">
