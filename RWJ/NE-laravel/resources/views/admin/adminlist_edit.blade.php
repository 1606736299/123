            ...
            <div class="col-sm-5 col-sm-offset-3">
                <div class="ibox float-e-margins" style="margin:0 auto;">
                    ...
                    <div class="ibox-content">
                        @foreach ($list as $v)
                        <form role="form" class="form-horizontal m-t" action="{{url('admin/adminlist_update')}}">
                            <input type="hidden" name="id" value="{{$v->id}}">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">用戶名：</label>
                                <div class="col-sm-5">
                                    <input type="text" name="username" class="form-control" value="{{$v->name}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="status" class="form-control" value="{{$v->status}}">
                                    <!-- <span class="help-block m-b-none">说明文字</span> -->
                                </div>
                            </div>
