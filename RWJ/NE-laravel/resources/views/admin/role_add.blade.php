            ...
            <div class="col-sm-5 col-sm-offset-3">
                <div class="ibox float-e-margins" style="margin:0 auto;">
                    ...
                    <div class="ibox-content">
                        <form role="form" class="form-horizontal m-t" action="{{url('role/list_insert')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <label class="checkbox-inline">
                                        <input type="checkbox" style="margin-top:3px;" name="pers[]"  value="{{$per->id}}">{{$per->display_name}}</label>
                                    @endforeach
                                </div>
                            </div>
