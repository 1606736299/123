                ...
                <div class="ibox-tools">
                 ...
                 <div class="input-group col-sm-3" style="float: right;position: relative;bottom:8px;">
                    ...
                    <span class="input-group-btn">
                        <a href="{{url('admin/adminlist_add')}}" class="btn btn-primary" style="margin-right: 20px;">添加管理员</a>
                    </span>
                </div>
            </div>
                            ...
                            <div class="example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$v->status}}</td>
                                        <td>{{$v->logintime}}</td>
                                        <td><a href="{{url('admin/adminlist_edit',$v->id)}}">修改</a> | <a href="{{url('admin/adminlist_del',$v->id)}}" onclick="javascript:return del()">删除</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
